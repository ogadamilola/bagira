...
const Preloader: React.FC<PreloaderProps> = ({
  ...
  return (
    <div className="fixed inset-0 overflow-hidden z-[99999] flex flex-col items-center justify-center h-[100vh] bg-[#0E0F11] cursor-wait splash-screen text-bagiWhite">
