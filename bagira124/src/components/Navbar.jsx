    ...
    <nav class="nav">
      <div class="nav-links-component">
        <a
          href="/#home"
          id="nav-home"
          class="nav-link home max-w-full h-full inline-block"
        >
        ...
        <a
          href="/#about"
          id="nav-about"
          class="nav-link about max-w-full h-full inline-block"
        >
        ...
        <a
          href="/#artwork"
          id="nav-artwork"
          class="nav-link artwork max-w-full h-full inline-block"
        >
        ...
        <a
          href="/#shop"
          id="nav-shop"
          class="nav-link shop max-w-full h-full inline-block"
        >
        ...
        <a
          href="/#gallery"
          id="nav-gallery"
          class="nav-link gallery max-w-full h-full inline-block"
        >
        ...
        <a
          href="/#location"
          id="nav-location"
          class="nav-link location max-w-full h-full inline-block"
        >
        ...
        <a
          href="/#murals"
          id="nav-murals"
          class="nav-link murals max-w-full h-full inline-block"
        >
