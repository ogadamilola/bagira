  ...
  return (
    <div className="pages-inquire-section">
      <div className="inquire-component">
        <div className="inquire-top">
          <div className="inquire-title">
            <h2 anim="1" split="words" className="jost-300-122 ">
              inquire today
            </h2>
          </div>
          ...
          <div
            ...
            className="inquire-cta-wrap"
          >
            <a
              data-w-id="cd947534-154b-d008-a35f-bce9f4afa8aa"
              href="#"
              className="pages-big-cta big-cta max-w-full h-full inline-block"
            >
      ...
      <img
        ...
        alt="EDIFICIO BAGIRA"
        className="pages-inquire-background-img pc"
      />
      <img
        ...
        alt="EDIFICIO BAGIRA"
        className="pages-inquire-background-img mobile"
      />
    </div>
  );
};
