...
const PaintingsSection = () => {
  return (
    <section id="paintings" class="paintings-section panel">
      ...
      <div class="paintings-component-top">
        {/* <div class="paintings-info">
          ...
          <div class="ap-info-bottom">
            ...
            <div class="paintings-cta">
              <a href="#paintings" class="cta-link c w-inline-block">
                <div
      ...
      <div class="paintings-component">
        {/* <div class="paintings-info-bottom">
          <div class="ap-info-bottom">
            <div class="paintings-sub-title">
              <div anim="3" split="words" class="jost-300-50 mb-40">
                Commission
